...
export default function DerivativeRulesStandards({username}) {
  ...
  useEffect(() => {
    // fetchStatus has side effects, what would be the noside effect patern
    fetchStatus();
  }, []);
  ...
  let sessionData = {
    ...
    progress: {
      standards: {
          derivatives: {
              derivativesRules: confidenceLevel
          }
      }        
    }
  }
        ...
        return (
          <div className="standardBox" key={standard.id}>
            ...
            <div className="rangeBox">
              <Form.Range
                value={confidenceLevel[standard.id]}
                name="confidence"
                ...
                id={standard.id}
              />
              <p className="rangeLevelLabel">Confidence Level: {confidenceLevel[standard.id]}</p>
            </div>
          </div>
        )
      })}
